...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var calendar = new _fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__["Calendar"](calendarEl, {
    ...
    dateClick: function dateClick(info) {
      ...
      console.log('Current view: ' + info.view.type); // change the day's background color just for fun
      // info.dayEl.style.backgroundColor = 'red';
    }
  });
  var userEvents = appSettings;
...
module.exports = __webpack_require__(/*! /Users/tomasztomzynski/Sites/czasomierzSS/resources/js/app.js */"./resources/js/app.js");
